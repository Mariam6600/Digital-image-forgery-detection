"""
Evaluation utilities for Methodology 2.

Run standalone with:  python -m src.evaluation --model-path models/ela_resnet101v2_head/best_ela_resnet101v2_head.keras
"""
import argparse
import json
import os
...
def _save_confusion_matrix_plot(cm, class_names, save_path):
    ...
    plt.title("Confusion Matrix — Methodology 2 (ELA + ResNet101V2)")
    plt.ylabel("Actual")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate a trained ELA-only ResNet101V2 checkpoint.")
